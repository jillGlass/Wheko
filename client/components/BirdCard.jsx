...
class BirdCard extends React.Component {
  render() {
    ...
    return (
      <React.Fragment>
        <Card bg="warning" style={{ width: "8rem", margin: '12px', border:'none', borderRadius: '0px'}}>
            ...
            <ListGroup  className="text-center">
              <ListGroupItem style={{padding: '0px', backgroundColor:'#ffc108', border: 'none' }}>Spotted: </ListGroupItem>
            </ListGroup>
            <ListGroup className="text-center">
